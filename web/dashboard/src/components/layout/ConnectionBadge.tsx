...
const config: Record<ConnectionState, { label: string; icon: typeof Wifi; className: string }> = {
  disconnected: { label: '未连接', icon: WifiOff, className: 'text-gray-400 bg-gray-100' },
  connecting: { label: '连接中', icon: Loader2, className: 'text-yellow-600 bg-yellow-50' },
  connected: { label: '已连接', icon: Wifi, className: 'text-green-700 bg-green-50' },
  reconnecting: { label: '重连中', icon: Loader2, className: 'text-orange-600 bg-orange-50' },
}
